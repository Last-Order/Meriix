            ...
            if (nowTrack.type === 'subtitle') {
                ...
                if (nowTrack.lang) {
                    if (subtitleLanguageNameMapping[nowTrack.lang.toLowerCase()]) {
                        command += `-metadata:s:${i} language="${subtitleLanguageCodeMapping[nowTrack.lang.toLowerCase()]}" -metadata:s:${i} handler="${subtitleLanguageNameMapping[nowTrack.lang.toLowerCase()]}" -metadata:s:${i} title="${subtitleLanguageNameMapping[nowTrack.lang.toLowerCase()]}" `;
                    } else {
